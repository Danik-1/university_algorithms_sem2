...
#ifndef TROYANGRAPH_HPP_
#define TROYANGRAPH_HPP_
...
class ListGraph : public Graph<VType, EType> {
 public:
    ListGraph(
      ...
      : vertexes_(vertexes), num_vertex_(vertexes.size()),
    ...
    IteratorImpl<VType, EType> NeighboursIt(
      VType v,
      const FilterFunction<EType>& filter) override {
...
void DFS(typename Graph::VertexType from, Graph* graph,
